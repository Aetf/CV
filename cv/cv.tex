...
\name{Peifeng Yu}
\info{%
    \faicon{map-marker} & 2543 Stone Rd, Ann Arbor, MI 48105, USA. \\
    \faicon{home}       & \href{https://unlimitedcodeworks.xyz}{unlimitedcodeworks.xyz} \\
...
\addtocategory{subpapers}{nsdi19}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Provides missing GPU sharing primitives: fast switching and memory sharing.
        \item Enforces fine-grained GPU sharing via a framework-independent, consolidated execution service.
        \item Improves the average completion time of DL training jobs by $3.19\times$
        \item Improves GPU utilization for hyper-parameter tuning by $2.38\times$, and for DL inference
        applications by $42\times$ over not sharing the GPU.
    \end{itemize}
    ...
    \begin{itemize}
        \item Built Storm topology with several video analysis workload, including classification, 
