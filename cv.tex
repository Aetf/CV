...
\begin{itemize}
    \item Contribution to open source Mozilla project \hfill \textit{From June, 2014 to present}
    \begin{itemize}
...
migration between uTorrent and qBittorrent.
    ...
    \item Software Low Power Mode Based on Protean Code \textit{From Sep., 2015 to Dec., 2015}
    \begin{itemize}
